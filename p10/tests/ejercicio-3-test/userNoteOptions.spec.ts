...
import {Note} from '../../src/ejercicio-3/noteApp/note';
import {UserNoteOptions} from '../../src/ejercicio-3/noteApp/userNoteOptions';
...
describe('Comprobar clase userNoteOptions - Tests', () => {
  ...
  it('Se puede crear una nueva nota ', () => {
    ...
    expect(fs.existsSync('src/ejercicio-3/db/Test/Nota_test.json')).true;
  });
  ...
  it('Se puede modificar una nota correctamente', () => {
    ...
    expect(fs.existsSync('src/ejercicio-3/db/Test/Nota_test.json')).true;
    let info = fs.readFileSync('src/ejercicio-3/db/Test/Nota_test.json');
  ...
  it('Se puede eliminar una nota correctamente', () => {
    ...
    expect(fs.existsSync('src/ejercicio-3/db/Test/Nota_test.json')).false;
    expect(fs.existsSync('src/ejercicio-3/db/Test/Nota_test2.json')).false;
  });
